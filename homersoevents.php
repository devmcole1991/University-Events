...
$query = $user_home->runQuery("SELECT * FROM event E, useradmin A, hosts H, rso R, joins J, makes M
                                    WHERE H.eventId = E.eventId AND H.userID = A.userID AND M.userID = A.userID AND M.RSOId = R.RSOId
                                    AND J.userID = $userID AND J.RSOId = R.RSOId AND E.privacy = 'rso' GROUP BY E.eventId");
