...
$query = $user_home->runQuery("SELECT * FROM event E, approvespriv Pr, hosts H, useradmin A, userstudent A2, creates C, universityprofile U
                                    WHERE E.eventId = Pr.eventId AND (H.eventId = E.eventId AND H.userID = A.userID 
                                    AND A2.userID = A.userID AND C.userID = $userID AND C.name = U.name AND A2.university = U.name) GROUP BY E.eventId");
                ...
                <div class="col-lg-12">
                    <div class="card card-plain">
                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            ...
                            <li>
                                <a href="superadminhomersoevents.php">
                                    ...
                                    <div class="card-footer">
                                        <div class="stats" style="width:100%;">
                                            ...
                                            <table class="table">
                                                ...
                                                <td style="text-align:left;">
                                                    <?php
                                                    $sql = "SELECT U.userName, I.commentString FROM commentinfo I, comments C, users U WHERE (I.commentId = C.commentId) AND (C.eventId = $eventId) AND (C.userID = U.userID) GROUP BY U.userID";
