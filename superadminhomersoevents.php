...
$query = $user_home->runQuery("SELECT * FROM event E, hosts H, useradmin A, userstudent A2, creates C, universityprofile U
                                    WHERE E.privacy = 'rso' AND (H.eventId = E.eventId AND H.userID = A.userID 
                ...
                <div class="col-lg-12">
                    <div class="card card-plain">
                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            ...
                            <li>
                                <a href="superadminhomeprivateevents.php">
                                    <i class="material-icons">account_balance</i>
                                    university events
                                    <div class="ripple-container"></div></a>
                            </li>
