...
$query = $user_home->runQuery("SELECT * FROM event E, approvespriv Pr, userstudent S, useradmin A, userStudent A2, hosts H
                                    WHERE E.eventId = Pr.eventId AND H.userID = A.userID AND H.eventId = E.eventId
                                    AND A2.userID = A.userID AND S.userID = $userID AND S.university = A2.university GROUP BY E.eventId");
